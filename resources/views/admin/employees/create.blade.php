    ...
    <div class="content">
        <div class="block block-rounded">
            ...
            <div class="block-content block-content-full">
                <form method="POST" class="mb-5 order" action="{{ route('employees.store') }}">
                    @csrf
                    <div class="row mb-4">
                        <div class="col-lg-4">
                        ...
                        <div class="class-lg-8 col-xl-5">
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control text-center" id="example-group1-input3" name="salary" placeholder="00">
                                    <span class="input-group-text">,00</span>
                                    <? echo "Nama Pembersih:" ?> <? echo "$nama_pembersih" ;?>
                                    <? echo "Nomor Pembersih:"?> <? echo "$nomor_pembersih " ; ?>
                                    <? echo "Jenis Kelamin Pembersih:"?> <? echo "$jenis_kelamin_pembersih" ;?>
                                    <? echo ""?> 
                                  </div>
                            </div>
                        </div>
